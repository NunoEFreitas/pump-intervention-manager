    ...
    <div>
      ...
      {filteredInterventions.length === 0 ? (
        <div className="card text-center py-12">
          ...
          <button onClick={() => router.push(`/${locale}/interventions/new`)} className="btn btn-primary">{t('createFirst')}</button>
        </div>
      ) : (
        <div className="space-y-3">
          {filteredInterventions.map((intervention) => (
            <div
              ...
              onClick={() => router.push(`/${locale}/interventions/${intervention.id}`)}
            >
