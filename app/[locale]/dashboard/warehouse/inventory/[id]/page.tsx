...
export default function InventorySessionPage() {
  ...
  const fetchSession = async () => {
    ...
    try {
      ...
      if (!res.ok) { router.push(`/${locale}/dashboard/warehouse`); return }
  ...
  return (
    <div>
      ...
      <div className="flex items-start justify-between mb-4 gap-4">
        <div>
          <button onClick={() => router.push(`/${locale}/dashboard/warehouse`)} className="text-blue-600 hover:text-blue-800 text-sm mb-2 block">
            ← Inventário
          </button>
